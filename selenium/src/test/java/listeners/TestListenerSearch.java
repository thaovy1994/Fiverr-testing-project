...
import reports.ExtentReportSearchManager;
...
public class TestListenerSearch implements ITestListener {
    private static final Logger logger = LoggerUtil.getLogger("SimpleListener");
    private static final ExtentReports extent = ExtentReportSearchManager.getInstance();
