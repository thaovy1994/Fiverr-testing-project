...
import reports.ExtentReportRegistrationManager;
...
public class TestListenerRegistration implements ITestListener {
    private static final Logger logger = LoggerUtil.getLogger("SimpleListener");
    private static final ExtentReports extent = ExtentReportRegistrationManager.getInstance();
